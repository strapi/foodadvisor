...
`npm run generate` allows you to auto-generate boilerplate code for common parts of your
...
If you aren’t satisfied with the build tool and configuration choices, you can `eject` at any time. `npm run eject` will remove the single build dependency from your project.
