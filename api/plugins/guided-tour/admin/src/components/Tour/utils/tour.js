  ...
  'content-type-builder': {
    steps: [
      ...
      },
      {
        ...
        content: () => (
          <div>
          <h1>Manage your Collection Types</h1><br />
          You can observe all the fields that make up this collection type like <strong>text</strong>, <strong>rich text</strong>, <strong>enumeration</strong>, <strong>relations</strong> etc...
          </div>
        ),
      },
      {
        ...
        content: () => (
          ...
          <strong>Reminder:</strong> Single types are handy to manage content like a homepage, an About us page, or any other type of content that is not part of a collection.<br /><br />
          <ul>
            <li>
      ...
      },
      {
        ...
        content: () => (
          <div>
          <h1>Single type</h1><br />
          It may seem complicated but this single type is composed of a <strong>Columns</strong> component which itself contains a <strong>Link</strong> component.<br />
          </div>
        ),
      },
      {
        selector: 'a[href="/admin/plugins/content-type-builder/component-categories/footer/footer.columns"]',
        content: () => (
          <div>
          <h1>Columns Component</h1><br />
          Here is the <strong>Columns</strong> component using itself the <strong>Link</strong> component just below.<br /><br />
          Components are very useful if you want to have the same fields for several collection types or single types. Instead of repeating yourself, you can <strong>create a component and reuse it in different collection types/single types</strong>.
          </div>
        ),
      },
      {
        ...
        content: () => (
          ...
          Creating the structure of our content is nice but what about seeing the actual content for each collection type now?<br />
          </div>
        ),
      },
      {
    ...
    steps: [
      {
        ...
        content: () => (
          <div>
          <h1>Content</h1><br />
          <strong>Great!</strong> Here is a list of content that has been created.<br />
      ...
      },
      {
        ...
        content: () => (
          ...
          <h1>Collection Types</h1><br />
            You can find all the other <strong>collection types</strong> on the main navigation everywhere in the admin panel.<br />
          </div>
        )
      },
      {
        ...
        content: () => (
          <div>
            ...
            This project includes the documentation plugin that takes out most of your pain to generate your documentation.<br />
      ...
      },
      {
        ...
        content: () => (
          <div>
          <h1>Settings</h1><br />
          General settings of your project. You can find the more advanced settings of the admin panel such as <strong>roles</strong>, <strong>permissions</strong>, <strong>webhooks</strong> etc...
          </div>
        )
      },
      {
        ...
        content: () => (
          <div>
          <h1>API</h1><br />
          I think it's time to let you play with this demo! But first you need to at least view your content <strong>through the API</strong>.<br /><br />
          ...
          <ul>
            ...
            <li>
              <strong>Add /restaurants</strong> just after the host of your demo url (ex: https://api-4p93j.strapidemo.com<strong>/restaurants</strong>) to see all your restaurants!
            </li>
          </ul>
          </div>
        ),
      },
      {
        ...
        content: () => (
          <div>
          <h1>Challenge 💪</h1><br />
          What do you say about a small challenge to allow you to really master Strapi?<br /><br />
          I suggest you to create a <strong>dish</strong> collection type containing the fields: name (<strong>text</strong>), ingredients (<strong>enumeration</strong>), price (<strong>number - decimal</strong>) and a relation linking to your Restaurant collection type with the following expression: <strong>Restaurants has many dishes</strong>.<br /><br />
      ...
      },
      {
        ...
        content: () => (
          <div>
          <h1>Thanks 👋</h1><br />
          However, thank you for following this guided tour. We hope that it was useful for you to understand how Strapi works!<br />
