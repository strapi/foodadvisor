              ...
              <div className="sm:w-1/2 text-center sm:pr-8 sm:py-8">
                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
                  <img
                    ...
                    src={getStrapiMedia(
                      delve(author, 'picture.formats.small.url')
                    )}
                  />
                </div>
                <div className="flex flex-col items-center text-center justify-center">
                  ...
                  <p className="text-base">{delve(author, 'description')}</p>
                </div>
              </div>
            </div>
          </div>
          <div className="markdown-body shadow-lg rounded-xl lg:w-3/6 w-full md:p-12 p-6 bg-white">
            <ReactMarkdown
              children={content}
              remarkPlugins={[gfm]}
              escapeHtml={false}
